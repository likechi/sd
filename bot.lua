...
function get_bot (i, adigram)
  ...
  function reload(chat_id,msg_id)
    ...
    send(chat_id, msg_id, "<code>ربات sd با موفقیت ریست شد و اماده به کار است✔️️</code>\n")
  end

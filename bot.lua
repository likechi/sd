		...
		if msg.content_.ID == "MessageText" then
			...
			if is_naji(msg) then
				...
				elseif text:match("^(تازه سازی ربات)$") then
					...
					elseif text:match("^leftall") then 
				...
				tdcli_function({ID="GetMe",},lkj, nil)
									return send(msg.chat_id_, msg.id_, "حله داداچ - SINAXHPM")
